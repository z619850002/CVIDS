...
public:
    ...
    void LoadParameters(
        ...
        double & m_cx,
        double & m_cy){
        m_k1 = this->mParameters.m_k1;
        m_k2 = this->mParameters.m_k2;
        m_p1 = this->mParameters.m_p1;
        m_p2 = this->mParameters.m_p2;
        m_fx = this->mParameters.m_fx;
        m_fy = this->mParameters.m_fy;
        m_cx = this->mParameters.m_cx;
        m_cy = this->mParameters.m_cy;
    }
