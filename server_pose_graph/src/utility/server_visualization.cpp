#include "../../include/utility/server_visualization.h"

const Eigen::Vector3d ServerVisualization::imlt = Eigen::Vector3d(-1.0, -0.5, 1.0);
const Eigen::Vector3d ServerVisualization::imrt = Eigen::Vector3d( 1.0, -0.5, 1.0);
const Eigen::Vector3d ServerVisualization::imlb = Eigen::Vector3d(-1.0,  0.5, 1.0);
const Eigen::Vector3d ServerVisualization::imrb = Eigen::Vector3d( 1.0,  0.5, 1.0);
const Eigen::Vector3d ServerVisualization::lt0 = Eigen::Vector3d(-0.7, -0.5, 1.0);
const Eigen::Vector3d ServerVisualization::lt1 = Eigen::Vector3d(-0.7, -0.2, 1.0);
const Eigen::Vector3d ServerVisualization::lt2 = Eigen::Vector3d(-1.0, -0.2, 1.0);
const Eigen::Vector3d ServerVisualization::oc = Eigen::Vector3d(0.0, 0.0, 0.0);
...
ServerVisualization::ServerVisualization(float r, float g, float b, float a)
    : m_marker_ns("ServerVisualization"), m_scale(0.2), m_line_width(0.01) {
...
void ServerVisualization::SetImageBoundaryColor(float r, float g, float b, float a) {
    m_image_boundary_color.r = r;
    m_image_boundary_color.g = g;
    m_image_boundary_color.b = b;
    m_image_boundary_color.a = a;
...
void ServerVisualization::SetOpticalCenterConnectorColor(float r, float g, float b, float a) {
    m_optical_center_connector_color.r = r;
    m_optical_center_connector_color.g = g;
    m_optical_center_connector_color.b = b;
    m_optical_center_connector_color.a = a;
...
void ServerVisualization::SetScale(double s) {
    m_scale = s;
}
void ServerVisualization::SetLineWidth(double width) {
    m_line_width = width;
}
void ServerVisualization::AddEdge(const Eigen::Vector3d& p0, const Eigen::Vector3d& p1){
...
void ServerVisualization::AddLoopEdge(const Eigen::Vector3d& p0, const Eigen::Vector3d& p1){
    //m_markers.clear();
    visualization_msgs::Marker marker;
...
void ServerVisualization::AddPose(const Eigen::Vector3d& p, const Eigen::Quaterniond& q) {
    visualization_msgs::Marker marker;
...
void ServerVisualization::Reset() {
	m_markers.clear();
    //image.points.clear();
    //image.colors.clear();
}

void ServerVisualization::PublishBy( ros::Publisher &pub, const std_msgs::Header &header ) {
...
void ServerVisualization::PublishImageBy( ros::Publisher &pub, const std_msgs::Header &header ) {
    image.header = header;
